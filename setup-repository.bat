@echo off
REM AI Gupshup Platform - Repository Setup Script (Windows)
REM This script helps create a dedicated repository for the AI Gupshup platform
...
REM Add new remote for the dedicated repository
